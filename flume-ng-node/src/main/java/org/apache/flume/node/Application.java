...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      /**
       * TODO 首先判断参数中是否含有z或者zkConnString，如果配置了这两个其中之一，那么会使用
       * TODO PolingZookeeperConfigurationProvider或StaticZookeeperProvider配置。
       */
      ...
      if (isZkConfigured) {
        ...
        /**
         * TODO 如果没有指定zookeeper，则使用指定的配置文件加载
         */
        File configurationFile = new File(commandLine.getOptionValue('f'));

        /*
         * The following is to ensure that by default the agent will fail on
         * startup if the file does not exist.（文件不存在就使用默认配置）
         */
