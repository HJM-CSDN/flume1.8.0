...
public interface Sink extends LifecycleAware, NamedComponent {
   ...
   * <p><strong>Note</strong>: This method should be consuming from the channel within the bounds of a Transaction. On successful delivery, the transaction should be committed, and on failure it should be rolled back.
   * TODO 此方法应该在事务的范围内从通道使用。在成功交付时，应该提交事务，在失败时应该回滚事务。
