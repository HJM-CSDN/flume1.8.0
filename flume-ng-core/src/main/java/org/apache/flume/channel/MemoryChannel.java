...
public class MemoryChannel extends BasicChannelSemantics {
  ...
  //TODO 大部分Channel都会把put和take直接委托给事务去完成
  //TODO MemoryTransaction 涉及到两个事务容量大小定义的队列（链表阻塞队列）、队列字节计数器、Channel操作的计数器
   ...
   */
  // TODO config方法中进行了一些参数的优化，如容量、Channel、Queue等。
  @Override
  public void configure(Context context) {
    ...
    //TODO 整个过程和Channel Queue数量容量初始化类似，但是最后做了前置条件判断，事务容量必须小于等于Channel Queue容量
